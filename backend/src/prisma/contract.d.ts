...
export type StorageHash =
  StorageHashBase<'d097ca6b5bef31805b5660a6b36be4a19ac6c12dce08ff80b8d9b7634a262255'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly OrderItem: {
      ...
      readonly comboItemId: CodecTypes['pg/int4@1']['output'] | null;
    };
    ...
    readonly Payment: {
      ...
      readonly providerRef: CodecTypes['pg/text@1']['output'];
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly PushToken: {
    ...
    readonly Ticket: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly orderItemId: CodecTypes['pg/int4@1']['output'];
      readonly qrCodePayload: CodecTypes['pg/text@1']['output'];
      readonly status: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly OrderItem: {
      ...
      readonly comboItemId: CodecTypes['pg/int4@1']['input'] | null;
    };
    readonly PartnerSeatState: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly sessionId: CodecTypes['pg/int4@1']['input'];
    ...
    readonly Payment: {
      ...
      readonly providerRef: CodecTypes['pg/text@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly PushToken: {
    ...
    readonly Ticket: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly orderItemId: CodecTypes['pg/int4@1']['input'];
      readonly qrCodePayload: CodecTypes['pg/text@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly comboItem: {
              ...
              indexes: readonly [
                {
                  readonly name: 'comboItem_partnerId_idx_bf5b312c';
                  readonly prefix: 'comboItem_partnerId_idx';
            ...
            readonly order: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'order_sessionId_idx_29f415d4';
                  readonly prefix: 'order_sessionId_idx';
            ...
            readonly orderItem: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['orderId', 'seatId'] }];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'orderItem_seatId_idx_3076c3cd';
                  readonly prefix: 'orderItem_seatId_idx';
                  readonly columns: readonly ['seatId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'orderItem_comboItemId_idx_536167b7';
                  readonly prefix: 'orderItem_comboItemId_idx';
                  readonly columns: readonly ['comboItemId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly payment: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['providerRef'] }];
              indexes: readonly [
                {
            ...
            readonly pushToken: {
              ...
              indexes: readonly [
                {
                  readonly name: 'pushToken_userId_idx_a489d58a';
                  readonly prefix: 'pushToken_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly sessionReminder: {
              ...
              indexes: readonly [
                {
                  readonly name: 'sessionReminder_userId_idx_a489d58a';
                  readonly prefix: 'sessionReminder_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'sessionReminder_sessionId_idx_29f415d4';
                  readonly prefix: 'sessionReminder_sessionId_idx';
                  readonly columns: readonly ['sessionId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'sessionReminder';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly ticket: {
              ...
              uniques: readonly [
                ...
                { readonly columns: readonly ['qrCodePayload'] },
              ];
              indexes: readonly [];
              foreignKeys: readonly [
                {
...
> & {
  ...
  readonly roots: {
    ...
    readonly comboItem: { readonly namespace: 'public' & NamespaceId; readonly model: 'ComboItem' };
    ...
    readonly pushToken: { readonly namespace: 'public' & NamespaceId; readonly model: 'PushToken' };
    readonly sessionReminder: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'SessionReminder';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly OrderItem: {
            ...
            readonly relations: {
              readonly comboItem: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'ComboItem';
                };
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['comboItemId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly order: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly comboItemId: { readonly column: 'comboItemId' };
              };
            };
          };
          readonly PartnerSeatState: {
          ...
          readonly SessionReminder: {
            ...
            readonly storage: {
              readonly table: 'sessionReminder';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
          ...
          readonly Ticket: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly qrCodePayload: { readonly column: 'qrCodePayload' };
                readonly status: { readonly column: 'status' };
